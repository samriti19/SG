...
APP_ACCESS_TOKEN = '2217532136.e95138b.3f60f5b863f34cbca4f7cf033229f1c5'
...
def like_a_post(insta_username):
    ...
    if post_a_like['meta']['code'] == 200:
        ...
        print 'Unseccessfully liked. Try again!'
    time.sleep(5)
...
def post_a_comment(insta_username):
    ...
    if make_comment['meta']['code'] == 200:
        ...
        print "Can't add comment. Try again!"
    time.sleep(5)
'''
...
def delete_negative_comment(insta_username):
    ...
    if comment_info['meta']['code'] == 200:
        if len(comment_info['data']):
            ...
            print 'No comments exist on tis post!'
    else:
        print 'Status code other than 200 received!'
    time.sleep(5)
'''
  Number of images shared on the basis of hash tags and plot the same using malplotib
'''
...
def start_bot():
    while True:
        ...
        print "j.Images shared on the basis of hashtag \n"
        print "k.Exit"
